...
class BoardServiceSpec extends Specification {
	...
	def "getMatchScore works"() {
		...
		then:
		result1 != null
		result1[Player.ONE] == 14
		result1[Player.TWO] == 7
		...
		then:
		result2 != null
		result2[Player.ONE] == 3
		result2[Player.TWO] == 12
	}
